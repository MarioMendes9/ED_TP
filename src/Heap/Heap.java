...
/**
 * Classe que representa uma Heap
 *
...
public class Heap<T> extends LinkedBinaryTree<T> implements HeapADT<T> {
    ...
    /**
     * Método responsavel por adicionar um elemento na Heap
     *
    ...
    /**
     * Encontra o elemento mais pequeno da Heap
     *
     * @return o elemento mais pequeno da Heap
     */
    @Override
    public T findMin() {
